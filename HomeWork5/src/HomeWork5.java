...
public class HomeWork5 {
     ...
     */
    public static void main(String[] args) throws Tester.CharacterCreationException {
        Tester Tester = new Tester("Test",100, 900, 1000);
        Mag Spirit = new Mag("Spirit", 65, 800,1000);
        Archer Archer = new Archer("Archer", 80,100, 9999);
        System.out.println(Spirit.talk());
        System.out.println(Archer.talk());


        Spirit.getLevel();
        Archer.setMaxHealth(2800);
        System.out.println(Archer.getName() + ":" + " "+ "Регенерация!" + " " + "Мои HP возвросли до" + " " + Archer.getMaxHealth());

        System.out.println(Tester.talk());
